...
contract ProductContract {
    ...
    function getTemperatureRange(TransportMode mode) internal pure returns (int, int) {
        if (mode == TransportMode.Frozen) {
            return (-25, -15);  // Min and Max temperatures for Frozen in Celsius
        } else if (mode == TransportMode.Refrigerated) {
            return (0, 4);  // Min and Max temperatures for Refrigerated in Celsius
        } else if (mode == TransportMode.Ambient) {
            return (15, 25);  // Min and Max temperatures for Ambient in Celsius
        } else {
